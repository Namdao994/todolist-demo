...
public class TodoController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<PageResponse<TodoResponse>>> getAllTodos(@RequestParam(defaultValue = "0") int page,
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<TodoResponse>> updateTodo(@PathVariable Long id, @Valid @RequestBody TodoUpdateRequest request) {
        Long userId = SecurityUtil.getCurrentUserId();
    ...
    public ResponseEntity<ApiResponse<TodoResponse>> AddTagToTodo(@PathVariable Long id, @PathVariable Long tagId) {
        Long userId = SecurityUtil.getCurrentUserId();
    ...
    public ResponseEntity<ApiResponse<TodoResponse>> removeTagFromTodo(@PathVariable Long id, @PathVariable Long tagId) {
        Long userId = SecurityUtil.getCurrentUserId();
    ...
    @PostMapping("/{id}/tags")
    public ResponseEntity<ApiResponse<TodoResponse>> createAndAddTagToTodo(@PathVariable Long id, @Valid @RequestBody TagCreateRequest request) {
        Long userId = SecurityUtil.getCurrentUserId();
